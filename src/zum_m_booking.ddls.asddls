...
define view entity ZUM_M_BOOKING as select from /dmo/booking_m
composition[0..*] of ZUM_M_BOOKSUPPL as _BookingSupplement
association to parent ZUM_M_TRAVEL as _Travel on
